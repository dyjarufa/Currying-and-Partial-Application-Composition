/* Escrever um crawler concorrente de uma api com restrições de acesso (rate limiting) */

/*
  - Duas listagem de produtos concorrentes de uma vez
  - Buscar detalhes de produtos a cada 5milisegundos
*/

const R = require('ramda')
const axios = require('axios')

// permite realizar queries concorrentemetne, recebendo uma lista de Promises
// É uma alernativa ao PromoiseAll, aqui consigo definir a quantidade de chamadas silmutâneas
